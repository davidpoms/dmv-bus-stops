...
if start == -1:
    raise Exception("Could not find submit_review route")

end = text.find('@app.route("/validation/update"', start)

if end == -1:
    raise Exception("Could not find end of submit_review function")
